                    ...
                    Card(
                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            Row(
                                ...
                                Column {
                                    Text(nextReservation?.clientName ?: "", style = MaterialTheme.typography.titleMedium, color = Color.White, fontWeight = FontWeight.Bold)
                                    Text(nextReservation?.serviceTitle ?: "", style = MaterialTheme.typography.bodyMedium, color = Color.White.copy(alpha = 0.9f))
                                }
                            ...
                            Row {
                                ...
                                Spacer(modifier = Modifier.width(4.dp))
                                Text("${nextReservation?.timeRange?.start} - ${nextReservation?.timeRange?.end}", color = Color.White, style = MaterialTheme.typography.bodySmall)
                            }
                        }
                    }
                } else {
                ...
                Card(modifier = Modifier.fillMaxWidth()) {
                    Column(modifier = Modifier.padding(16.dp)) {
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            ...
                            Text(FormatUtils.formatRating(uiState.ratingSummary?.averageRating ?: 0.0), style = MaterialTheme.typography.titleLarge)
                        }
                    }
                }
            }
